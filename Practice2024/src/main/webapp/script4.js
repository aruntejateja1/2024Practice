...
document.getElementById("demo4").innerHTML=typeof true;

var x=document.getElementsByTagName("p");
x[1].innerHTML="Hi element by tag name";

var x=document.getElementById("div");
var y=x.getElementsByTagName("p");
y[0].innerHTML="p child1";

var x=document.getElementsByClassName("intro");
x[0].innerHTML="get elements by class name";
document.write("<br/>"+x[0].innerHTML);

var x=document.querySelectorAll("p.intro1");
x[0].innerHTML="p querySelectorAll";

/*function myfunctionform(){
	var x=document.forms["form1"];
	//document.write("<br/>"+x.elements[0].value);
	document.getElementById("formshow").innerHTML=x.elements[0].value;
	for(var t=0;t<=1;t++){
		document.getElementById("formshow").innerHTML=x.elements[0].value;
		//document.write("<br/>"+x.elements[i].value);

	}
}

document.write("<br/>"+"t value: "+t);
document.write("<br/>"+document.getElementById("formshow").innerHTML);*/
...
function submit1(){
	...
	x.style.backgroundColor="red";
	alert("onsubmit option clicked  " + x.value);
}


document.getElementById("myBtn1").addEventListener("click", function myfunctionadd(){
	document.getElementById("remove").innerHTML="Hello world!";
	//document.getElementById("remove").firstChild.nodeValue="Hello world!";
	//document.getElementById("remove").childNodes[0].nodeValue="Hello world!";
});

function myfunctionremove(){
	document.getElementById("myBtn1").removeEventListener("click",myfunctionadd);
}

/*document.getElementById(myBtn2).addEventListener("click", function myfunctionremove(){
	document.getElementById("myBtn1").removeEventListener("click",myfunctionadd);
});*/
...
document.getElementById("demo8").innerHTML="Node name: "+document.getElementById("demo8").nodeName+ " Node Type:  "+document.getElementById("demo8").nodeType;
...
var x=document.getElementsByTagName("p");
document.write("<br/>"+"Total number of p tags: "+x.length);
...
function selectOption(){
	...
	//var ctt=conn.options[conn.selectedIndex].value;
		var ctt=conn.options[conn.selectedIndex].id;
	//document.write("<br/>"+ctt);
alert(ctt);
}
